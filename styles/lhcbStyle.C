...
///////////////////////////////////////////////////////////////////
  ...
  //lhcbStyle->SetOptStat("Mr");  // show only nent -e , mean - m , rms -r
  // full opts at http://root.cern.ch/root/html/TStyle.html#TStyle:SetOptStat
  lhcbStyle->SetStatFormat(".3g"); // specified as c printf options
  // lhcbStyle->SetOptTitle(0);
  lhcbStyle->SetOptFit(0);
  //lhcbStyle->SetOptFit(11); // order is probability, Chi2, errors, parameters
  lhcbStyle->SetFitFormat(".3g"); 
 //titles
  ...
  lhcbStyle->SetStatFontSize(0.06);
  lhcbStyle->SetStatX(0.9);
  lhcbStyle->SetStatY(0.95);
  lhcbStyle->SetStatW(0.14);
  lhcbStyle->SetStatH(0.17);
  //lhcbStyle->SetStatColor(0);
  //lhcbStyle->SetStatStyle(0);  
